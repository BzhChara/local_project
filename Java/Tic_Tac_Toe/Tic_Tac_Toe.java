    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            for (int j = 0; j < board[0].length; j++) {
                if (Arrays.equals(new String[] { board[0][j], board[1][j], board[2][j] },
                        new String[] { "O", "O", "O" })) {
                    winner = "the first one";
                    break;
                } else if (Arrays.equals(new String[] { board[0][j], board[1][j], board[2][j] },
                        new String[] { "X", "X", "X" })) {
                    winner = "the second one";
                    break;
                }
            ...
            if (Arrays.equals(new String[] { board[0][0], board[1][1], board[2][2] }, new String[] { "O", "O", "O" })) {
                winner = "the first one";
                break;
            } else if (Arrays.equals(new String[] { board[0][2], board[1][1], board[2][0] },
                    new String[] { "O", "O", "O" })) {
                winner = "the first one";
                break;
            } else if (Arrays.equals(new String[] { board[0][0], board[1][1], board[2][2] },
                    new String[] { "X", "X", "X" })) {
                winner = "the second one";
                break;
            } else if (Arrays.equals(new String[] { board[0][2], board[1][1], board[2][0] },
